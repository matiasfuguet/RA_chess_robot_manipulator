def pinza48():
  ...
  set_payload(0.75)
  set_tool_voltage(0)
  step_count_04e78eb2_0c31_459b_b572_7068dca396fe = 0.0
  thread Step_Counter_Thread_a81a63dc_52af_4f56_9650_e080e46b25d2():
    while (True):
      step_count_04e78eb2_0c31_459b_b572_7068dca396fe = step_count_04e78eb2_0c31_459b_b572_7068dca396fe + 1.0
      sync()
    end
  end
  run Step_Counter_Thread_a81a63dc_52af_4f56_9650_e080e46b25d2()
  ...
  global zmastcp=p[0,0,0.18659,0,-0,-1.57079]
  ...
  def RG2(target_width=110, target_force=40, payload=0.0, set_payload=False, depth_compensation=False, slave=False):
  	set_tcp(p[0,0,0.18659,0,-0,-1.57079])
  	grip_detected=False
  	if slave:
  ...
  while (True):
    ...
    #   Type: RG2
    $ 2 "RG2(46)"
    RG2(46,40,0.0,True,False,False)
